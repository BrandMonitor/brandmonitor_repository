...
<style>
   ...
   .inp_srh{-webkit-appearance:none; /*去除系统默认的样式*/box-shadow: none;width:60%;
	...
	/*服务*/
    .service{height: 100%;margin: 10px auto;}
	...
	.menu img{width:30px;}
	/*footer*/
	footer{position:relative;font-family: "微软雅黑";font-size: 12px;margin: 0 auto;
	color:#999999;}
	/*item2*/
...
<body>
	<div class="main">
        ...
        <div class="search">
        	...
        	<input class="btn_srh" type="submit" name="submit" value="注册查询">
        </div>
        <!--搜索框下方menu-->
        <div class="menu">
        	<div>
	...
	<script>
		$(function(){
			$(".btn_srh").click(function(){
		   		...
		   		window.location.href = '/trademark/h/i/trademark/trademark_mobile?trademark='+trademark;
		   })
