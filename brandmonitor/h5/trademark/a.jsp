    			...
    			<div class="hor">
					...
					<div class="hor">
    					...
    					<div class="position">
    						...
    						<span id="PersonImg_testWarn" style="display:nonel;" class="min_tip min_tip_optional">复印件签字后上传扫描件，jpg格式、小于10M</span>
    
    						<div class="scdimgupcs_business" style="display:none;" id="secondhide">
    							<img style="margin-top: 20px;" class="pattern_business"  id="secondImageText" src="" width="65" height="65" alt="图例" />
    							<a href="#"></a>
