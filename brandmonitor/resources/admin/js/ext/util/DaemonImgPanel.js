Ext.define('Ext.util.DaemonImgPanel', {
	extend: "Ext.panel.Panel",  
    requires: [
                
     ],
	alternateClassName: 'DaemonImgPanel',
	layout: 'border',
	border: false,
	src: "",
	type:'D:\\hmfy\\',
	...
	initComponent: function() {
			...
			listeners:{
				click:function(){
					if(daemonFilePanel==null||daemonFilePanel.getEl( ) ==null){
						...
						daemonFilePanel=Ext.create('Ext.util.DaemonAliyunFilePanel', {
							 isForm:true,
							 formMe:form,
							 formKey:me.formKey,
							 visit:me.type,
		...
		me.CustomdelBtn = Ext.create('Ext.button.Button', {
			...
			listeners:{
				click:function(){
					 me.setHeight(130);
					 me.changingImage.setHeight(130);
					 me.changingImage.setSrc("");
