Ext.define('Ext.util.DaemonAliyunFileToOSSPanel', {
	extend: "Ext.window.Window",  
    requires: [
                
     ],
	alternateClassName: 'DaemonAliyunFileToOSSPanel',
	height: 400,
	width: 600,
	layout: {
        type: 'border'
	...
	initComponent: function() {
		...
		var appTypeComboBox=Ext.create('Ext.form.ComboBox', {
			store: {
				fields: ['name', 'value'],
				data : [
...
//				fields: ['name', 'value'],
//				data : [
//				    {"value":1, "name":"普通图片（小于100k）"},
//				    {"value":5, "name":"动态图片（小于500k）"}
//				]
//			},
//		    editable:false,
//		    autoSelect:true,
...
//		});
		...
		var customPanel=Ext.create('Ext.util.DaemonCustomPanel', {
			...
			visit:me.visit,
		    daemonFormItems: [
		    	{fieldLabel: '请选择一个文件',xtype: 'filefield',name: 'appFile',msgTarget: 'side',allowBlank: false,buttonText: '选择文件',labelStyle: 'font-weight:bold;padding:0'},
		    	,appTypeComboBox
				,{fieldLabel: '版本名',name: 'versionName',flex:3,allowBlank: true,inputId:'versionName',value:'',minLength:1,maxLength:20,regexText:'1-20个字符',blankText:'1~20个字符',labelStyle: 'font-weight:bold;padding:0'}
				,{fieldLabel: '版本号',name: 'versionNum',flex:3,allowBlank: true,inputId:'versionNum',value:'',minLength:1,maxLength:20,regexText:'1-20个字符',blankText:'1~20个字符',labelStyle: 'font-weight:bold;padding:0'}
				,{fieldLabel: '更新说明',name: 'remark',flex:3,allowBlank: true,inputId:'remark',value:'',minLength:1,maxLength:20,regexText:'1-100个字符',blankText:'1~100个字符',labelStyle: 'font-weight:bold;padding:0'}
//		    	show,
//		    	size
		    	],
		    listeners:{
