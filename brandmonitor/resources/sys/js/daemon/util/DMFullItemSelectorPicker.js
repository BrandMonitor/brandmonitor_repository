...
*/
Ext.define('Daemon.util.DMFullItemSelectorPicker', {
	extend:'Ext.panel.Panel',  
	alias: 'Daemon.DMFullItemSelectorPicker',
	alternateClassName: 'DMFullItemSelectorPicker',
	requires: [ 
	           'Ext.data.Store',
	           'Ext.Button',
	           'Ext.grid.Panel',
...
//		        	me.fireEvent('r_drop',node,data,overModel,dropPosition,eOpts);
		...
		Ext.apply(me,{
     		items:[me.leftPanel,me.rightPanel]
		});
...
//		});
	...
	leftAdd:function(rowIndex){
		...
		if(me.checkIsExist(rec.get(me.left_or_right_mark_id))){
			alert("数据已经存在！");
			return null;
		}
