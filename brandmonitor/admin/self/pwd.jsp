...
<script>
	$(function(){
		var id = '${sessionScope.micro80WeiXinSession.id}';
		var user_name = '${sessionScope.micro80WeiXinSession.userName}';
		var tel = '${sessionScope.micro80WeiXinSession.tel}';
		var pwd = '${sessionScope.micro80WeiXinSession.password}';
